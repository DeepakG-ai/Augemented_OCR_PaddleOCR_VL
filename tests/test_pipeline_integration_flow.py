...
class WorkerFlowIntegrationTests(unittest.IsolatedAsyncioTestCase):
    async def test_full_pipeline_flow_populates_extraction_artifacts(self) -> None:
        ...
        async def fake_set_extraction_status(_pool, extraction_id: int, status: str, progress=None, error=None, duration_ms=None, end_to_end=False):
        ...
        self.assertIsNone(extraction["export_object_key"])
        self.assertEqual(ensured_jobs, ["ocr", "llm", "postprocess"])
